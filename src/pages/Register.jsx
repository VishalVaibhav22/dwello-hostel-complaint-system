...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.university || !formData.fullName || !formData.email ||
            !formData.password || !formData.hostel || !formData.roomNumber) {
            ...
            <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
                <div className="w-full max-w-sm">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-gray-600 mt-2">Join your hostel community</p>
                    </div>

                    {/* Registration Form */}
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* University Dropdown - REQUIRED for students, No free-text */}
                        <div>
                            <select
                                id="universitySelect"
                                name="university"
                        ...
                        {/* Email Input - Used as login identifier */}
                        <div>
                            <input
                                id="emailInput"
                                name="email"
                        ...
                        {/* Password Input - Basic validation (non-empty) */}
                        <div>
                            <input
                                id="passwordInput"
                                name="password"
                        ...
                        {/* Hostel Dropdown - Restricted to predefined values */}
                        <div>
                            <select
                                id="hostelInput"
                                name="hostel"
                        ...
                        {/* Message Display - Show validation/backend errors */}
                        {message.text && (
                            <div
                    ...
                    {/* Social Sign-Up (UI only, not functional) */}
