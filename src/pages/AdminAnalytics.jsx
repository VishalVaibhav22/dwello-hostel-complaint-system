...
import { getAdminAnalytics } from "../api/complaints";
import {
  Chart as ChartJS,
  ArcElement,
  BarElement,
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
          ...
          <p className="text-xs text-gray-400 mt-1">Complaints acknowledged</p>
        </div>
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
          <p className="text-gray-500 text-sm font-medium mb-1">
            Avg. Resolution Time
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-500">
              Most frequent:{" "}
              {analytics?.categoryAnalytics?.mostFrequentCategory || "Other"}
            </span>
          </div>
            ...
            <div>
              <div className="flex justify-between text-sm mb-1.5">
                ...
                <span className="font-medium text-gray-900">
                  {sd.total > 0 ? Math.round((sd.open / sd.total) * 100) : 0}%
                </span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    {sd.open} complaint{sd.open !== 1 ? "s" : ""} need attention
                  </p>
                </div>
              </div>
