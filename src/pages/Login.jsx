            ...
            <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-sm">
                    ...
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-semibold text-gray-900">Sign in to your account</h2>
                    </div>
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-center space-x-1 bg-gray-100 p-1 rounded-lg">
                            <button
                                ...
                                className={`flex-1 py-2.5 px-4 rounded-md font-medium text-sm transition-all ${selectedRole === ROLES.STUDENT
                            ...
                            <button
                                ...
                                className={`flex-1 py-2.5 px-4 rounded-md font-medium text-sm transition-all ${selectedRole === ROLES.ADMIN
                                    ? 'bg-white text-gray-900 shadow-sm'
                                    : 'text-gray-600 hover:text-gray-900'
                                    }`}
                            >
